...
export const translations = {
  en: {
    ...
    mobileStep2: "Tap the search icon (magnifying glass) at the bottom right",
    mobileStep3: "Tap 'Sites' tab, then paste the URL below",
    copyUrl: "Copy URL",
  ...
  pt: {
    ...
    mobileStep2: "Toque no ícone de busca (lupa) no canto inferior direito",
    mobileStep3: "Toque na aba 'Sítios', depois cole a URL abaixo",
    copyUrl: "Copiar URL",
  ...
  es: {
    ...
    securityTitle: "Tu Seguridad es Nuestra Prioridade",
    ...
    mobileStep2: "Toca el ícono de búsqueda (lupa) en la esquina inferior derecha",
    mobileStep3: "Toca la pestaña 'Sitios', luego pega la URL abajo",
    copyUrl: "Copiar URL",
    urlCopied: "¡URL Copiada!",
  },
}
